...
# ==========================================
class AbsorptionFitterDashboard(BaseModelingDashboard):
    ...
    def set_active_data(self, x_data: np.ndarray, y_data: np.ndarray, metadata_dict: dict):
        ...
        saved_data = self.metadata.get("analysis_settings", {}).get("absorption_fitter_data")
        if saved_data:
    ...
    def save_parameters_to_session(self):
        ...
        self.metadata["analysis_settings"]["absorption_fitter_data"] = {
