...
TECHNIQUE_CONFIG = {
    ...
    "Impedance Calibration": {
        ...
        "analysis_options": [
            ...
            "calibrated_sample_color",
            "calibrated_sample_alpha",
...
ANALYSIS_OPTION_META: dict[str, dict] = {
    ...
    "min_frequency": {
        ...
        "tooltip": "Exclude data points below this frequency value",
        "type":    "numeric",
        "min":     0.0,
        "max":     1000000000.0,
        "default": 0.0,
    ...
    "max_frequency": {
        ...
        "tooltip": "Exclude data points above this frequency value",
        "type":    "numeric",
        "min":     0.0,
        "max":     1000000000.0,
        "default": 100000000.0,
    ...
    "open_color": {
        "label":   "Open Color",
        "tooltip": "Select color for Open scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "black",
        "category": "Scans",
    ...
    "open_alpha": {
        "label":   "Open Alpha",
        "tooltip": "Opacity for Open scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "short_color": {
        "label":   "Short Color",
        "tooltip": "Select color for Short scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "black",
        "category": "Scans",
    ...
    "short_alpha": {
        "label":   "Short Alpha",
        "tooltip": "Opacity for Short scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "load_color": {
        "label":   "Load Color",
        "tooltip": "Select color for Load scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "green",
        "category": "Scans",
    ...
    "load_alpha": {
        "label":   "Load Alpha",
        "tooltip": "Opacity for Load scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "known_load_color": {
        "label":   "Known Load Color",
        "tooltip": "Select color for Known Load scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "red",
        "category": "Scans",
    ...
    "known_load_alpha": {
        "label":   "Known Load Alpha",
        "tooltip": "Opacity for Known Load scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "sample_color": {
        "label":   "Sample Color",
        "tooltip": "Select color for Sample scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "blue",
        "category": "Scans",
    ...
    "sample_alpha": {
        "label":   "Sample Alpha",
        "tooltip": "Opacity for Sample scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "sample2_color": {
        ...
        "tooltip": "Select color for Sample 2 scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "brown",
        "category": "Scans",
    ...
    "sample2_alpha": {
        "label":   "Sample 2 Alpha",
        "tooltip": "Opacity for Sample 2 scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
    ...
    "calibrated_sample_color": {
        "label":   "Calibrated Sample Color",
        "tooltip": "Select color for Calibrated Sample scan trace",
        "type":    "combo",
        "options": TRACE_COLORS,
        "default": "black",
        "category": "Scans",
    ...
    "calibrated_sample_alpha": {
        "label":   "Calibrated Sample Alpha",
        "tooltip": "Opacity for Calibrated Sample scan trace",
        "type":    "slider_numeric",
        "min":     0.0,
        "max":     1.0,
        "default": 0.7,
